...
const data = {
  id: 'education-ai',
  breadcrumbs: ['Enterprise Solutions', 'Education AI'],
  hero: {
    titleLight: 'Education',
    titleBold: 'AI',
    description: "Personalize learning pathways with adaptive assessment engines, automated essay grading, predictive student at-risk retention analytics, and 24/7 intelligent academic tutoring.",
    bgImage: img1
  },
  metricsBanner: [
  {
    "value": "1:1",
    "label": "Personalized Tutoring Scale"
  },
  {
    "value": "85%",
  ...
  {
    "value": "92%",
    "label": "At-Risk Retention Prediction"
  },
  {
    "value": "+24%",
    "label": "Average Test Score Gain"
  }
],
  overview: {
