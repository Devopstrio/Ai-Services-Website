...
export default function IndustriesManaged() {
  return (
    <section style={styles.section}>
      ...
      >
        Scale Industry Transformation with <span style={{ color: "#E11D48" }}>Managed Delivery</span>
      </motion.h2>

      <div style={styles.grid}>
        <TextCard
          span="span 2"
          label="Cross-Industry AI Delivery"
          heading="Accelerate domain-specific enterprise transformation."
          description="Unify vertical business workflows with enterprise-grade intelligence. We manage end-to-end industry AI lifecycles from regulatory compliance and custom model tuning to continuous production monitoring."
          bg="#0b0b0b"
        />
        <StatCard
          span="span 1"
          number="3.5x"
          description="faster time-to-market across healthcare, banking, retail, and manufacturing with our pre-built industry accelerators."
          bg="#E11D48"
        />
        <PatternCard span="span 1" />
        <TextCard
          span="span 1"
          label="Domain-Driven Engineering"
          heading="Access deep sector expertise and specialized engineering."
          description="Deploy engineering squads trained in vertical standards—from HIPAA & FHIR in Healthcare to Basel III in Banking and Industry 4.0 in Manufacturing."
          bg="#161616"
        />
        <TextCard
          span="span 1"
          label="Core Modernization"
          heading="Modernizing mission-critical legacy industry platforms."
          description="Bridge legacy core banking, clinical EHRs, ERPs, and SCADA systems with intelligent automation and secure cloud-native architectures."
          bg="#0a0a0a"
        />
      </div>
    </section>
