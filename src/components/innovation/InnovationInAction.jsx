  ...
  return (
    <section ref={sectionRef} style={styles.section}>
      <div style={styles.imageCol}>
        ...
        >
          <img src={labActionImg} alt="Innovation Lab" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.75 }} />
        </motion.div>
      ...
      <div style={styles.textCol}>
        ...
        >
          ...
          <p style={styles.paragraph}>
            ...
            infrastructure needed to experiment freely. Stop guessing what AI can do — 
