...
import integrationActionImg from "../../assets/fresh/integration_hybrid_network.jpg";
...
export default function IntegrationInAction() {
  ...
  return (
    <section ref={sectionRef} style={styles.section}>
      <div style={styles.imageCol}>
        ...
        >
          <img src={integrationActionImg} alt="System Integration" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.75 }} />
        </motion.div>
