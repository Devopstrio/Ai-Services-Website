...
import serverHubImg from "../../assets/fresh/agent_automated_qa_pipeline.jpg";
...
function PatternCard({ span }) {
  return (
    ...
    >
      <img src={serverHubImg} alt="Server Hub" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.65 }} />
      <div style={styles.imgOverlay} />
    </motion.div>
  );
}

export default function CapabilitiesManaged() {
  return (
    <section style={styles.section}>
      ...
      >
        Scale AI with <span style={{ color: "#E11D48" }}>Managed Delivery</span>
      </motion.h2>
      ...
      <div style={styles.grid}>
        <TextCard
          ...
          heading="Unify enterprise data streams into a single AI-ready pipeline."
          description="Surface the right insight the moment it matters. We manage your entire AI operations lifecycle from data ingestion to model deployment and continuous monitoring."
          bg="#0b0b0b"
        />
        <StatCard
          span="span 1"
          number="2x"
          description="faster deployment times reported by our enterprise clients using our managed MLOps pipelines."
          bg="#E11D48"
        />
