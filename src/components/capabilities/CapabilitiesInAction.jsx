...
import actionImg from "../../assets/fresh/73bd7abeb45365336cdce7e9fff4b338.jpg";
...
export default function CapabilitiesInAction() {
  ...
  return (
    <section ref={sectionRef} style={styles.section}>
      <div style={styles.imageCol}>
        ...
        >
          <img src={actionImg} alt="AI in Action" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.7 }} />
        </motion.div>
